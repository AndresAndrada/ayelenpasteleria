...
export default function FormLogin() {
  ...
  return (
    <div className="w-100% max-w-96 sm:w-96 inline-flex p-6 flex-col justify-center items-center gap-8 rounded-lg bg-white shadow-4xl">
      <div>
        <Toaster />
      </div>
      ...
      >
        ...
        <div className="flex flex-col w-full items-start gap-2">
          ...
          >
            ...
            {/* <img
              src={showPassword ? <IoEyeSharp /> : <FaEyeSlash />}
              alt=""
